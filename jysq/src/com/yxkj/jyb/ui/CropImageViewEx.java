...
public class CropImageViewEx extends ImageView {
	...
	public CropImageViewEx(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public CropImageViewEx(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setDrawable(Drawable drawable, int cropWidth, int cropHeight) {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (super.getDrawable().getIntrinsicWidth() == 0
				|| super.getDrawable().getIntrinsicHeight() == 0) {
			return;
		}
	...
	protected void configureBounds() {
		...
		if (isFrist) {
			oriRationWH = ((float) super.getDrawable().getIntrinsicWidth())
					/ ((float) super.getDrawable().getIntrinsicHeight());

			final float scale = mContext.getResources().getDisplayMetrics().density;
			int w = Math.min(getWidth(), (int) (super.getDrawable().getIntrinsicWidth()
					* scale + 0.5f));
